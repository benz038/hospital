...
console.log("Welcome to NIT-TRICHY Hospital");
...
db.getConnection((err, connection) => {
        ...
        const sqlCheckDoctor = "SELECT * FROM doctors WHERE doctor_name = ?";
        connection.query(sqlCheckDoctor, [doctor_name], (err, result) => {
            if (err) throw err;
            ...
            // If the doctor exists, proceed with inserting the appointment
            ...
            connection.query(insert_query, (err, result) => {
                ...
                res.redirect('/appointment_success'); // Redirect to a success page
            });
        });
...
app.get('/appointment_success', (req, res) => {
...
app.post("/add_review", (req, res)=> {
    ...
    connection.query(insert_query, (err, result) => {
        ...
        res.redirect('/fb-success'); // Redirect to a success page
});
});
}
);
